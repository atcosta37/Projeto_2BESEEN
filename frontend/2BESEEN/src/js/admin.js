document.getElementById("abrirInboxBtn").onclick = function() {
    ...
    function mostrarDetalhesEncomenda(pedido) {
        ...
        const encomendaCampos = [
            { label: "Tamanho", valor: pedido.tamanho },
            ...
            { label: "Arquivo", valor: pedido.arquivo },
            { label: "Base Stand", valor: (pedido.baseLargura && pedido.baseProfundidade) ? `${pedido.baseLargura} x ${pedido.baseProfundidade}` : undefined },
            ...
            { label: "Imagem", valor: pedido.imagem ? `<a href="${pedido.imagem}" target="_blank">Ver imagem</a>` : undefined }
        ].filter(campo => campo.valor !== undefined && campo.valor !== "" && campo.valor !== null);
